...
import click
from deeppcb.base import resize
...
@click.command()
@click.option('-c', '--cfg', default=osp.join(base_dir, '/home/vision/users/dengsx/pcb_py/deeppcb/config/config.toml'))
@click.option('--ann', default='/home/vision/users/dengsx/pcb_py/data_bench_server/templates/BR0100P04W0070087A1_L3/annotations/annotation.toml')
...
# def main(cfg, ann, no_valid_mask, src, dst):
    ...
    for scale, img, out_dir in [
        ...
        print('cur_body_bbox',cur_body_bbox)
        print('w_th',w_th)
        ...
        for ci, cam_id in enumerate(cam_ids):
            ...
            print('---------',ci, cam_id)
            print('cad_cut_x0',cad_cut_x0,cad_cut_y0,cad_cut_x1,cad_cut_y1)
